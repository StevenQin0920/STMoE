...
class SingleSTMoEImputer(Predictor):
    ...
    def __init__(self,
                 ...
                 whiten_prob: Union[float, List[float]] = 0.25,
        ...
        super(SingleSTMoEImputer, self).__init__(model_class=model_class,
    ...
    def on_train_batch_start(self, batch, batch_idx: int) -> None:
        ...
        :math:`p = \texttt{self.whiten\_prob}`. Then, whiten missing values in
         :obj:`batch.input.x`"""
        super(SingleSTMoEImputer, self).on_train_batch_start(batch, batch_idx)
    ...
    def add_argparse_args(parser, **kwargs):
        ...
        parser.add_argument('--whiten-prob', type=float, default=0.25)
